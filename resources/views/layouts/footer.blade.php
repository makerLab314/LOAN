...
<footer class="footer relative pt-1 sm:pt-5 md:pt-10 mx-auto bg-gray-600">
    ...
    <div class="max-w-screen-lg xl:max-w-screen-xl mx-auto px-4 sm:px-6 md:px-8 mt-8 border-b-0">
        ...
        <ul
            ...
            <li class="space-y-2 sm:space-y-3 row-span-2 px-4">
                ...
                <ul class="space-y-1">
                    <li>
                        ...
                        <p class="text-gray-300 transition-colors duration-200 font-normal mt-2"><em><strong>LOAN | {{ __('Das System zur Geräteausleihe') }}</strong></em> ist eine Plattform von <a
                        ...
                        <div
                            ...
                            <a href="https://github.com/dusanvin/LOAN" target="_blank" rel="noopener"
                                ...
                                <span class="ml-1">{{ __('Sterne') }}</span>
                            </a>
                ...
                <ul class="space-y-1">
                    <li>
                        <a class="text-gray-300 hover:text-white transition-colors duration-200 font-normal"
                            href="{{ url('/product') }}" target="_blank" rel="noopener">{{ __('Produkt') }}</a>
                    </li>
                    <li>
                        <a class="text-gray-300 hover:text-white transition-colors duration-200 font-normal"
            ...
            <!-- Über -->
            <li class="space-y-2 sm:space-y-3 row-span-2 px-4">
                <p class="text-xs font-semibold tracking-wide text-gray-200 uppercase">{{ __('Über') }}</p>
                <ul class="space-y-1">
                    <li>
                        <a class="text-gray-300 hover:text-white transition-colors duration-200 font-normal"
                            href="{{ url('/impressum') }}" target="_blank" rel="noopener">{{ __('Impressum') }}</a>
                    </li>
                    <li>
                        <a class="text-gray-300 hover:text-white transition-colors duration-200 font-normal"
                            href="{{ url('/datenschutz') }}" target="_blank" rel="noopener">{{ __('Datenschutz') }}</a>
                    </li>
                </ul>
            </li>
            <!-- Allgemein -->
            <li class="space-y-2 sm:space-y-3 row-span-2 px-4">
                <p class="text-xs font-semibold tracking-wide text-gray-200 uppercase">{{ __('Allgemein') }}</p>
                <ul class="space-y-1">
                    <li>
                        <a class="text-gray-300 hover:text-white transition-colors duration-200 font-normal"
                            href="mailto:vincent.dusanek@gmail.com">{{ __('Kontakt') }}</a>
                    </li>
                </ul>
            </li>
        </ul>
