    ...
    <div class="container mx-auto">
        ...
        <p class="mb-8 flex items-center text-sm">Füge dem System ein neues Gerät hinzu.
            <a href="{{ route('devices.index') }}" class="hover:underline text-yellow-600 flex items-center pl-1">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" height="18"
                    width="18" class="ml-1">
        ...
        <form action="{{ route('devices.store') }}" method="POST" enctype="multipart/form-data" class="w-full">
            ...
            <div class="mb-4">
                <label for="title" class="block text-gray-700 text-sm font-bold mb-2">Name & Label inkl. Seriennummer
                    (SN) (z.B. <em>HTC VIVE Pro 2 #1 (SN: 82682630)</em>):</label>
            ...
            <div class="mb-4">
                <label for="description" class="block text-gray-700 text-sm font-bold mb-2">Beschreibung & Details
                    (Aufbewahrungsort wie Schranknummer/Fach, z.B. <em>1/F</em> & Besonderheiten):</label>
                <textarea rows="4" name="description" id="description"
                    class="bg-gray-50 focus:ring-gray-500 focus:border-gray-500 appearance-none border border-gray-300 rounded w-full py-2 px-3 text-gray-700 leading-tight">{{ old('description') }}</textarea>
            </div>

            <div class="mb-4">
                <label for="image" class="block text-gray-700 text-sm font-bold mb-2">Bild (*.jpg/*.jpeg etc.):</label>
                <input type="file" name="image" id="image"
                    class="appearance-none rounded w-full py-2 px-0 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
            </div>
