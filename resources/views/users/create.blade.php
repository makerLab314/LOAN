...
@section('title', 'Konto hinzufügen')

@section('content')
    <div class="container mx-auto">
        <div class="flex justify-between items-center">
            <h1 class="text-2xl font-bold mb-4">Konto hinzufügen</h1>
            <p class="mb-2">
                <span id="animated-icon" class="flex items-center gap-1 rounded-full bg-red-50 py-0.5 pl-2 pr-2.5 text-sm font-medium text-red-600">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="h-6 transition-transform">
        ...
        <p class="mb-8 flex items-center text-sm">Füge dem System ein neues Konto hinzu.
            <a href="{{ route('users.index') }}" class="hover:underline text-yellow-600 flex items-center pl-1">
                Du möchtest zur Übersicht über alle Konten? Folge mir!
